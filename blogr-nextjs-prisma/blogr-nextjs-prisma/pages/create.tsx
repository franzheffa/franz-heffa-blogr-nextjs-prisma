...
const Draft: React.FC = () => {
  ...
  const submitData = async (e: React.SyntheticEvent) => {
    ...
    try {
      ...
      await fetch('/api/post', { method: 'POST', headers: {'Content-Type':'application/json'}, body: JSON.stringify(body) });
  ...
  return (
    <Layout>
      ...
      <style jsx>{`
        input[type='text'], textarea { width:100%; padding:.5rem; margin:.5rem 0; border-radius:.25rem; border:.125rem solid rgba(0,0,0,.2); }
